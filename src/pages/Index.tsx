        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Изучайте английский{" "}
              <span className="text-purple-500 font-extrabold">весело</span> и{" "}
              <span className="text-purple-500 font-extrabold">доступно</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-md">
              Индивидуальный подход для школьников с особыми образовательными
              потребностями. Делаем обучение английскому языку понятным и
              увлекательным!
            </p>
            <div className="flex gap-4">
              ...
              <Button variant="outline">Попробовать бесплатно</Button>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Learning Buddy предлагает уникальные инструменты для эффективного
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-purple-500">
              <CardHeader>
                ...
                <CardDescription>
                  Программа подстраивается под индивидуальный темп и стиль
            ...
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-blue-400">
              <CardHeader>
                ...
                <CardDescription>
                  Награды, достижения и персонализированная обратная связь для
            ...
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-orange-400">
              <CardHeader>
                ...
                <CardDescription>
                  Визуальные, аудио и интерактивные материалы для улучшения
            ...
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-green-400">
              <CardHeader>
                ...
                <CardDescription>
                  Подробная статистика и анализ успеваемости для учеников,
            ...
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-red-400">
              <CardHeader>
                ...
                <CardDescription>
                  Форумы и чаты для общения с преподавателями и другими
                  учениками
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow border-t-4 border-t-yellow-400">
              <CardHeader>
                ...
                <CardDescription>
                  Увлекательные задания и мини-игры для закрепления материала в
                  интересной форме
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Специально разработанные модули с учетом различных образовательных
              потребностей
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Изучение букв и их звучания через интерактивные
                        упражнения
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Простые диалоги и фразы для повседневного общения
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Основной словарный запас с визуальной поддержкой
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <TabsContent value="intermediate" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Расширенная грамматика и словарный запас для повседневного
                    общения
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-orange-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Изучение времен и основных грамматических структур
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-indigo-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Практика разговорной речи в контексте повседневных
                        ситуаций
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-pink-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Чтение и анализ текстов среднего уровня сложности
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-cyan-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Структурированные эссе и другие форматы академических
                        текстов
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-amber-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Погружение в культурные особенности англоязычных стран
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Мы всегда готовы помочь с любыми вопросами и сложностями в
                обучении
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                      Получите немедленную помощь от квалифицированных
                      преподавателей английского языка в режиме реального
                      времени.
                    </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                      Запишитесь на персональную видео-консультацию для разбора
                      сложных тем и вопросов.
                    </p>
                ...
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium">
                      Как начать занятия на платформе?
                    </h4>
                    <p className="text-gray-600 mt-2">
                      Просто зарегистрируйтесь, пройдите короткий тест для
                      определения вашего уровня, и система предложит
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-gray-600 mt-2">
                      ...
                      устройств, что позволяет учиться в любом удобном месте.
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium">
                      Как родителям отслеживать прогресс ребенка?
                    </h4>
                    <p className="text-gray-600 mt-2">
                      В личном кабинете родителя доступна подробная статистика
                      занятий, успехи, проблемные зоны и рекомендации для
      ...
      <section className="py-16 bg-purple-600 text-white">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-6">
            Готовы начать свой путь к свободному владению английским?
          </h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Присоединяйтесь к тысячам школьников, которые уже улучшили свои
            знания с Learning Buddy
          </p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">
                Образовательная платформа, делающая изучение английского языка
                доступным для всех школьников
              </p>
            </div>
